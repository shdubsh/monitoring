...
# FIXME: Each test could use a purpose statement.
describe 'monitoring::host' do
  ...
  context 'with an icinga host' do
    ...
    # FIXME: Invalid test.  Transitive dependencies too deep.  Requires transitive dependency through profile::base to base::monitoring::host.
